...
|---|---------|-------------|-------|---------|
| 1 | [AdventureWorks Azure ETL + Unity Catalog](https://github.com/rutujak-git/AdventureWorks-Azure-ETL-UnityCatalog-Lakehouse) | End-to-end ETL pipeline using AdventureWorks2022 dataset — SSMS, Azure SQL DB, ADF, ADLS Gen2, Databricks Unity Catalog & Power BI | ADF · Databricks · Unity Catalog · Power BI | [▶ Watch](https://youtu.be/Mzxn0eGKfso?si=6-iqEJZ5dTDgq3Ap) |
| 2 | [Amazon Prime Data Pipeline](https://github.com/rutujak-git/Azure-Data-Pipeline-AmazonPrimeDataset-adf-adlsgen2-databricks-powerbi) | Medallion Architecture pipeline with HTTP ingestion via ADF, PySpark transformations & ADLS Gen2 on Amazon Prime Movies & TV Shows dataset | ADF · PySpark · ADLS Gen2 · Power BI | [▶ Watch](https://youtu.be/J1cyf5B1wWU?si=3Njr9bu4oxWTc5lw) |
| 3 | [Databricks Delta Lake ETL](https://github.com/rutujak-git/Azure-Databricks-UnityCatalog-DeltaLake-ETL-Pipeline) | ETL pipeline with Unity Catalog, Medallion Architecture (Bronze/Silver/Gold) & Delta Lake optimization techniques | ADLS Gen2 · Databricks · Delta Lake · Unity Catalog · Python · Databricks Dashboard| [▶ Watch](https://youtu.be/hUTDVTuZO60?si=AjykpFaOwVnrrUFr) |
